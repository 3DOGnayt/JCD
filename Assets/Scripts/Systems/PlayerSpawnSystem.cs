...
namespace Systems
{
    public sealed class PlayerSpawnSystem : ISystem 
    {
        ...
        private void SpawnPlayer()
        {
            ...
            AddGameComponents(entity, instance.transform);
            AddInternalComponents(entity);
            entity.SetComponent(new PlayerTagComponent());
        }

        private void AddGameComponents(Entity entity, Transform instanceTransform)
        {
            entity.SetComponent(new SpeedComponent { Value = 100});
        }

        private void AddInternalComponents(Entity entity)
        {
