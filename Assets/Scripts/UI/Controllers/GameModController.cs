...
namespace UI.Controllers
{
    public class GameModController : AUiController<GameModView>
    {
        ...
        private void OnTrainingButtonClick() => _gameSelectionParameters.SetSelectedGameMode(EGameMod.Training);

        private void OnStoryButtonClick() => _gameSelectionParameters.SetSelectedGameMode(EGameMod.Story);
